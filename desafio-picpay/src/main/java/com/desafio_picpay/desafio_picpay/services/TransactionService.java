...
import com.desafio_picpay.desafio_picpay.dtos.TransactionDTO;
...
public class TransactionService {
    ...
    @Autowired
    private RestTemplate restTemplate; //chamadas http
    ...
    public boolean authorizeTransaction(User sender, BigDecimal value) {
        ResponseEntity<Map> authorizationResponse = restTemplate.getForEntity("run.mocky/io/v3/fafdd68-a090-496f-8c9a-3442cf30dae6", Map.class);
